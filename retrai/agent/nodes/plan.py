...
def _build_system_prompt(goal: Any, state: AgentState) -> str:
    ...
    return (
        ...
        "(preferred for targeted edits, supports occurrence param)\n"
        "- `file_delete`: Delete a file or empty directory\n"
        "- `file_rename`: Rename or move a file within the project\n"
        "- `file_insert`: Insert text at a specific line number\n"
        ...
        "importance\n"
        "- `bio_search`: Search biomedical databases — PubMed (literature), "
